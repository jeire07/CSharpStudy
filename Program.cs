...
namespace CSharpStudy
{
    internal class Program
    {
        ...
        {
            //CS01HelloWorld hello = new CS01HelloWorld();
            //hello.UseAllMethod();

            // if you want to run Sorting code,
            // uncomment the following 2 lines.
            CS08Sorting sortItems = new CS08Sorting();
            sortItems.UseAllSorting();
            ...
            // uncomment the following 2 lines.
            //Game02Snake snake = new Game02Snake();
            //snake.PlaySnake();

            // if you want to run blackjack game code,
            // uncomment the following 2 lines.
            //game03blackjack blackjack = new game03blackjack();
            //blackjack.playblackjack();
        }
    }

    public class Game02Snake
    {
        public void PlaySnake()
        {
            ...
            while (true)
            {
                ...
                SetCursorPosition(0, 21); // 커서 위치 설정
                WriteLine($"먹은 음식 수: {foodCount}"); // 먹은 음식 수 출력
            }
